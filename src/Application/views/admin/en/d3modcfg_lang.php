...
//Navigation
    ...
    'D3_CFG_MOD_EXC_NOMODCFGITEM'              => 'no modcfg item for this id available [<a href="https://faq.d3data.de/module/modul-connector/fehlermeldung-keine-modulkonfiguration-fuer-diese-id-vorhanden/" target="faq">more info</a>]',
    'D3_CFG_MOD_EXC_LICENSERESULT'             => 'license result is: %s [<a href="https://faq.d3data.de/module/modul-connector/fehlermeldung-lizenzpruefung-ergibt/" target="faq">more info</a>]',
    'D3_CFG_MOD_EXC_NOCONFKEY'                 => 'no conf key available [<a href="https://faq.d3data.de/module/modul-connector/keine-basiskonfiguration-fuer-das-modul-vorhanden/" target="faq">more info</a>]',
    'D3_CFG_MOD_EXC_UNKNOWNCONFKEY'            => 'conf key isn\'t conform (ModId, ModVersion) [<a href="https://faq.d3data.de/module/modul-connector/fehlermeldung-basiskonfiguration-passt-nicht-zum-modul-modid-modversion/" target="faq">more info</a>]',
    'D3_CFG_MOD_EXC_NOLICKEYFORCHECK'          => 'license key missing: license activation required [<a href="https://faq.d3data.de/module/modul-connector/fehlermeldung-fehlender-lizenzschluessel/" target="faq">more info</a>]',
    'D3_CFG_MOD_EXC_NOCONFKEYID'               => 'can\'t read conf key [<a href="https://faq.d3data.de/oxid-eshop/module-oxid-eshop/aktivierung/basiskonfiguration-kann-nicht-gelesen-werden/" target="faq">more info</a>]',
    'D3_CFG_MOD_EXC_NOSERIALID'                => 'can\'t read license key [<a href="https://faq.d3data.de/oxid-eshop/module-oxid-eshop/aktivierung/lizenzschluessel-kann-nicht-gelesen-werden/" target="faq">more info</a>]',
    ...
    'D3_SHGENERATOR_CRON_PROFIHOST_PHP73'      => 'Profihost (PHP 7.3)',
    'D3_SHGENERATOR_CRON_PROFIHOST_PHP74'      => 'Profihost (PHP 7.4)',
