...
//Navigation
    ...
    'D3_UPDATE_MSG_DISABLED_MODCFGMODULE'              => 'Der D3-Modul-Connector ist durch die Shopsoftware temporär deaktiviert worden. Bitte aktivieren Sie diesen umgehend wieder, dass hierdurch keine Fehler ausgelöst werden.'.PHP_EOL.PHP_EOL.'So reaktivieren Sie das Modul:'.PHP_EOL.'- klicken Sie auf den "Ausführen"-Button auf dieser Seite *oder*'.PHP_EOL.'- rufen Sie dazu im Adminbereich ihres Shops den Menüpunkt "Erweiterungen -> Module" auf - Führen Sie die Aktivierung unbedingt vor den nächsten Installationsschritten aus.'.PHP_EOL.PHP_EOL.'In einer Enterprise Edition mit mehreren Mandanten ist die Reaktivierung in jedem eingerichteten Shop nötig.',
