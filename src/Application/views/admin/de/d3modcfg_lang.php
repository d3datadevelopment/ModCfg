...
//Navigation
    ...
    'D3_CFG_MOD_EXC_LICENSERESULT'             => 'Lizenzprüfung ergibt: %s [<a href="https://faq.d3data.de/module/modul-connector/fehlermeldung-lizenzpruefung-ergibt/" target="faq">mehr Infos</a>]',
    'D3_CFG_MOD_EXC_NOCONFKEY'                 => 'keine Basiskonfiguration für das Modul vorhanden [<a href="https://faq.d3data.de/module/modul-connector/keine-basiskonfiguration-fuer-das-modul-vorhanden/" target="faq">mehr Infos</a>]',
    'D3_CFG_MOD_EXC_UNKNOWNCONFKEY'            => 'Basiskonfiguration passt nicht zum Modul (ModId, ModVersion) [<a href="https://faq.d3data.de/module/modul-connector/fehlermeldung-basiskonfiguration-passt-nicht-zum-modul-modid-modversion/" target="faq">mehr Infos</a>]',
    'D3_CFG_MOD_EXC_NOLICKEYFORCHECK'          => 'fehlender Lizenzschlüssel: Lizenzaktivierung erforderlich [<a href="https://faq.d3data.de/module/modul-connector/fehlermeldung-fehlender-lizenzschluessel/" target="faq">mehr Infos</a>]',
    'D3_CFG_MOD_EXC_NOCONFKEYID'               => 'Basiskonfiguration kann nicht gelesen werden [<a href="https://faq.d3data.de/oxid-eshop/module-oxid-eshop/aktivierung/basiskonfiguration-kann-nicht-gelesen-werden/" target="faq">mehr Infos</a>]',
    'D3_CFG_MOD_EXC_NOSERIALID'                => 'Lizenzschlüssel kann nicht gelesen werden [<a href="https://faq.d3data.de/oxid-eshop/module-oxid-eshop/aktivierung/lizenzschluessel-kann-nicht-gelesen-werden/" target="faq">mehr Infos</a>]',
