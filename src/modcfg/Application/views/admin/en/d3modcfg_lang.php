...
//Navigation
    'charset'                                  => 'UTF-8',
    'd3mxd3modules'                            => "<i class='fa fa-d3 fa-d3color-blue'></i> Module",
    'd3mxcfg'                                  => "<i class='fa fa-gears'></i> Module Connector",
    ...
    'd3mxtplblocks'                            => "<i class='fa fa-d3 fa-d3color-blue'></i> tpl blocks",
