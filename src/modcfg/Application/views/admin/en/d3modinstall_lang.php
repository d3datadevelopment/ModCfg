...
//Navigation
    ...
    'D3_UPDATE_MSG_DISABLED_MODCFGMODULE'              => 'The D3 module connector has been temporarily deactivated by the shop software. Please activate this immediately, that this does not trigger any errors. '. PHP_EOL.PHP_EOL.'To reactivate the module:'. PHP_EOL .'- click on the "Run" -button on this page * or * '. PHP_EOL .'- call up in the admin area of your shop the menu item "Extensions -> Modules" - Execute the activation necessarily before the next installation steps. '. PHP_EOL.PHP_EOL.'In an enterprise edition with several clients, the reactivation is in every configured shop needed.',
