...
<style type="text/css">
    ...
    #d3install_lib_cfg table {
        width: 100%;
    }
    #d3install_lib_cfg table td {
        width: 50%;
    }
</style>
...
<form name="myedit" id="myedit" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <table border="0" id="d3install_lib_cfg">
        <tr>
                        ...
                        <td>
                            <span class="d3modcfg_btn icon d3color-green">
                                <button type="submit" name="save">
                                    <i class="fa fa-check-circle fa-inverse"></i>[{oxmultilang ident="D3_CFG_MOD_SAVE"}]
                                </button>
                            </span>
                        </td>
                        <td></td>
