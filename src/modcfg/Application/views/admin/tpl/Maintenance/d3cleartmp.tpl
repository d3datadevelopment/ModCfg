                            ...
                            <td class="edittext"><br>
                                ...
                                <span class="d3modcfg_btn icon d3color-green[{if $blDevMode}]_inactive[{/if}]">
                                    <button id="sumbitbtn" type="submit" name="save" [{if $blDevMode}]disabled="disabled" [{/if}] style="width: 150px;">
                                        <i class="fa fa-check-circle fa-inverse"></i>[{oxmultilang ident="D3_CFG_CLRTMP_SUBMIT"}]
                                    </button>
                                </span>
                            </td>
                        </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        [{if $oCfg->getValue('blClrTmp_nofolderremove')}]
                                            class="fa fa-times-circle fa-17x fa-d3color-red" title="[{oxmultilang ident="D3_CFG_CLRTMP_NO"}]"
                                        [{else}]
                                            class="fa fa-check-circle fa-17x fa-d3color-green" title="[{oxmultilang ident="D3_CFG_CLRTMP_YES"}]"
                                        [{/if}]
                                        ></span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        [{if $oCfg->getValue('sClrTmp_excluderegexp')}]
                                            class="fa fa-times-circle fa-17x fa-d3color-red" title="[{oxmultilang ident="D3_CFG_CLRTMP_YES"}]"
                                        [{else}]
                                            class="fa fa-check-circle fa-17x fa-d3color-green" title="[{oxmultilang ident="D3_CFG_CLRTMP_NO"}]"
                                        [{/if}]
                                        ></span>
                                        [{oxinputhelp ident="D3_CFG_CLRTMP_SET_DESC"}]
                                    </td>
...
<div id="popup" class=""><i class="fa fa-spinner fa-4x fa-pulse fa-pull-left"></i><span>[{oxmultilang ident="D3_CFG_CLRTMP_MSG1"}] [{oxmultilang ident="D3_CFG_PLEASEWAIT"}]</span></div>
