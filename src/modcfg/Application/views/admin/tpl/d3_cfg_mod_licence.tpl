                            ...
                            <div style="border-bottom: 1px solid silver;">
                                ...
                                <div style="margin: 23px 0;">
                                    ...
                                    [{if $oView->checkModuleVersion() != 'OK'}]
                                        <i class="fa fa-exclamation-triangle fa-17x fa-d3color-red" style="display:inline-block;"></i>
                                                            ...
                                                            [{if $oView->getInstallClass()}]
                                                                    [{if $oView->getUpdateData('autoupdate') > 0}]
                                                                        ...
                                                                        <div class="d3modcfg_btn icon d3color-blue" style="margin: 10px 0 0 0;">
                                                                            <button type="submit">
                                                                                <i class="fa fa-question-circle fa-inverse"></i>[{oxmultilang ident="D3_CFG_MOD_VERSION_UPDLOAD5"}]
                                                                            </button>
                                                                        </div>
                                                                    [{/if}]
                                                                </form>
                                ...
                                [{else}]
                                    <div style="padding: 15px 0 40px;">
                                        <form name="myedit" id="check_update" action="[{$oViewConf->getSelfLink()}]" method="post">
                                            ...
                                            <div class="d3modcfg_btn icon d3color-blue" style="margin: 10px 0 0 0;">
                                                <button type="submit">
                                                    <i class="fa fa-question-circle fa-inverse"></i>[{oxmultilang ident="D3_CFG_MOD_VERSION_STARTCHECK"}]
                                                </button>
                                            </div>
                                        </form>
                                        <div></div>
                    ...
                    <dl>
                        <dt>
                            <div style="float: right; margin: 20px;">
                                <i class="fa fa-d3 fa-d3color-blue" style="font-size: 6em;"></i>
                            </div>
                            ...
                            <ul>
                                <li class="syscheck">
                                    [{if $oView->d3CheckCurl()}]
                                        <i class="fa fa-check-circle fa-17x fa-d3color-green" style="display: inline; margin: 0;"
                                           title="[{oxmultilang ident="D3_CFG_MOD_SYS_CURLOK"}]"></i>
                                        &nbsp;[{oxmultilang ident="D3_CFG_MOD_SYS_CURLOK"}]
                                    [{else}]
                                        [{if $oView->d3ModUseCurl()}]
                                            <i class="fa fa-times-circle fa-17x fa-d3color-red" style="display: inline; margin: 0;"
                                               title="[{oxmultilang ident="D3_CFG_MOD_SYS_CURLREQ"}]"></i>
                                            &nbsp;[{oxmultilang ident="D3_CFG_MOD_SYS_CURLREQ"}]
                                        [{else}]
                                            <i class="fa fa-exclamation-triangle fa-17x fa-d3color-orange" style="display: inline; margin: 0;"
                                ...
                                [{foreach from=$oInstallCheck->getArray() item="oCheckItem"}]
                                    <li class="syscheck">
                                        [{if $oCheckItem->hasCheckPassed()}]
                                            <i class="fa fa-check-circle fa-17x fa-d3color-green"
                                        [{else}]
                                            <i class="fa fa-times-circle fa-17x fa-d3color-red"
                                        [{/if}]
                            ...
                            [{if $oView->hasBlogContent()}]
                                <ul>
                                    [{foreach from=$oView->hasBlogContent() item="oBlog"}]
                                        <li class="syscheck">
                                            <i class="fa fa-arrow-circle-right fa-17x fa-d3color-blue" style="display: inline; margin: 0;" title="[{$oBlog->title|replace:'"':''}]"></i>
...
[{include file="d3_cfg_mod_inc.tpl" blChangeTitle=false blHideLinkBar=false}]
