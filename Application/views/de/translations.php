...
//    'D3_CFG_LIB_REVISION'                      => 'Rev.',
    ...
    'D3_CFG_CLRTMP_CLI_COMMON_RUNFROMCLI'  => 'Dieses Script muss von der Befehlszeile aus ausgeführt werden.',  //deprecated
    'D3_CFG_CLRTMP_CLI_COMMON_NOVALIDTYPE' => 'Kein gültiger Typ definiert.',  // deprecated
    'D3_CFG_CLRTMP_CLI_HELP'               => 'Löscht Objekte aus dem TMP-Ordner.',  // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_VERSION'     => 'zeigt Version',   // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_QUIET'       => 'verhindert die Anzeige der Ausgabe',   // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_LANG'        => 'optional - Sprache der ausgegebenen Meldungen, mögliche Werte sind: "%1$s"',  // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_HELP'        => 'Diesen Hilfetext anzeigen und den Aufruf verlassen.',  // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_NOCOLORS'    => 'Verwendet keine Farben in der Ausgabe. Nützlich bei der Weitergabe der Ausgabe an andere Tools oder Dateien.',  // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_LOGLEVELS'   => 'Kleinstes Level der anzuzeigenden Meldungen. Standard ist "info". Gültige Stufen sind: "%1$s".',  // deprecated
    'D3_CFG_CLRTMP_CLI_COMMAND'            => 'Dieses Tool akzeptiert einen Befehl als ersten Parameter, wie unten beschrieben:',  // deprecated
    'D3_CFG_CLRTMP_CLI_COMMAND_RUN'        => 'Ausführen des Löschauftrages',   // deprecated
    'D3_CFG_CLRTMP_CLI_ARGUMENT_TYPE'      => 'Typen der zu löschenden Objekte, mögliche Werte sind: "%1$s"',  // deprecated
    'D3_CFG_CLRTMP_CLI_ARGUMENT_ENCLOSER'  => '", "',   // deprecated
    'D3_CFG_CLRTMP_CLI_FINISHED_SUCCFESSFULLY' => 'Das Script wurde erfolgreich beendet.',   // deprecated
    'D3_CFG_CLRTMP_UNKNOWN_ACTION'         => 'Aktion "%s" ist nicht in der Aktionsliste',  // deprecated
    ...
    'D3_LOG_CLI_COMMON_RUNFROMCLI'          => 'Dieses Script muss von der Befehlszeile aus ausgeführt werden.',  // deprecated
    'D3_LOG_CLI_HELP'                       => 'Ermöglicht die Ausführung von Wartungsaufgaben.',   // deprecated
    'D3_LOG_CLI_OPTION_VERSION'             => 'zeigt Version',   // deprecated
    'D3_LOG_CLI_OPTION_QUIET'               => 'verhindert die Anzeige der Ausgabe',  // deprecated
    'D3_LOG_CLI_OPTION_LANG'                => 'optional - Sprache der ausgegebenen Meldungen, mögliche Werte sind: "%1$s"',   // deprecated
    'D3_LOG_CLI_OPTION_HELP'                => 'Diesen Hilfetext anzeigen und den Aufruf verlassen.',   // deprecated
    'D3_LOG_CLI_OPTION_NOCOLORS'            => 'Verwendet keine Farben in der Ausgabe. Nützlich bei der Weitergabe der Ausgabe an andere Tools oder Dateien.',  // deprecated
    'D3_LOG_CLI_OPTION_LOGLEVELS'           => 'Kleinstes Level der anzuzeigenden Meldungen. Standard ist "info". Gültige Stufen sind: "debug", "info", "notice", "success", "warning", "error", "critical", "alert", "emergency".',  // deprecated
    'D3_LOG_CLI_COMMAND'                    => 'Dieses Tool akzeptiert einen Befehl als ersten Parameter, wie unten beschrieben:',  // deprecated
    'D3_LOG_CLI_COMMAND_CLEANUPLOG'         => 'bereinigt die d3log-Tabelle um Einträge, die älter als die angegebene Zeit sind',   // deprecated
    'D3_LOG_CLI_COMMAND_LOGSTATUS'          => 'Statusinfos zur d3log-Tabelle anzeigen',  // deprecated
    'D3_LOG_CLI_COMMAND_LOGSTATUS_COUNT'    => 'Anzahl', // deprecated
    'D3_LOG_CLI_COMMAND_LOGSTATUS_TYPE'     => 'Logtyp', // deprecated
    'D3_LOG_CLI_COMMAND_LOGSTATUS_DATE'     => 'Datum',  // deprecated
    'D3_LOG_CLI_ARGUMENT_ENCLOSER'          => '", "',   // deprecated
    'D3_LOG_CLI_ARGUMENT_VALUE'             => 'Zeitwert (Ganzzahl - die "6" bei "6 Monate")',  // deprecated
    'D3_LOG_CLI_ARGUMENT_UNIT'              => 'Zeiteinheit, mögliche Werte sind: "%1$s"', // deprecated
    'D3_LOG_CLI_FINISHED_AFFECTED'          => '%1$s Einträge wurden entfernt',          // deprecated
    'D3_LOG_CLI_FINISHED_SUCCFESSFULLY'     => 'Das Script wurde erfolgreich beendet.',  // deprecated
    'D3_LOG_CLI_UNVALID_PARAMETERS'         => 'Fehlende oder ungültige Parameter, bitte prüfen Sie die übergebenen Argumente', // deprecated
