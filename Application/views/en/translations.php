...
//    'D3_CFG_LIB_REVISION'                      => 'rev.',
    ...
    'D3_CFG_MOD_LICDETAILS_FORMERR'            => 'Please reload the form and select an option.',
    ...
    'D3_CFG_CLRTMP_CLI_COMMON_RUNFROMCLI'  => 'This script has to be run from the command line',  // deprecated
    'D3_CFG_CLRTMP_CLI_COMMON_NOVALIDTYPE' => 'no valid type defined',  // deprecated
    'D3_CFG_CLRTMP_CLI_HELP'               => 'delete objects from temporary folder',  // deprecdated
    'D3_CFG_CLRTMP_CLI_OPTION_VERSION'     => 'print version',   // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_QUIET'       => 'prevents output from being displayed',  // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_LANG'        => 'optional - language of the output messages, possible values are: "%1$s"',   // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_HELP'        => 'Display this help screen and exit immeadiately.',  // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_NOCOLORS'    => 'Do not use any colors in output. Useful when piping output to other tools or files.',  // deprecated
    'D3_CFG_CLRTMP_CLI_OPTION_LOGLEVELS'   => 'Minimum level of messages to display. Default is "info". Valid levels are: "%1$s".',   // deprecated
    'D3_CFG_CLRTMP_CLI_COMMAND'            => 'This tool accepts a command as first parameter as outlined below:',  // deprecated
    'D3_CFG_CLRTMP_CLI_COMMAND_RUN'        => 'Execution of the deletion order',   // deprecated
    'D3_CFG_CLRTMP_CLI_ARGUMENT_TYPE'      => 'Types of objects to be deleted, possible values are "%1$s"',  // deprecated
    'D3_CFG_CLRTMP_CLI_ARGUMENT_ENCLOSER'  => '", "',   // deprecated
    'D3_CFG_CLRTMP_CLI_FINISHED_SUCCFESSFULLY' => 'script successfully finished',  // deprecated
    'D3_CFG_CLRTMP_UNKNOWN_ACTION'         => 'action "%s" is not in list',   // deprecated
    ...
    'D3_LOG_CLI_COMMON_RUNFROMCLI'          => 'This script has to be run from the command line',  // deprecated
    'D3_LOG_CLI_HELP'                       => 'Enables remote execution of maintenance tasks',  // deprecated
    'D3_LOG_CLI_OPTION_VERSION'             => 'print version',  // deprecated
    'D3_LOG_CLI_OPTION_QUIET'               => 'prevents output from being displayed',  // deprecated
    'D3_LOG_CLI_OPTION_LANG'                => 'optional - language of the output messages, possible values are: "%1$s"',   // deprecated
    'D3_LOG_CLI_OPTION_HELP'                => 'Display this help screen and exit immeadiately.',   // deprecated
    'D3_LOG_CLI_OPTION_NOCOLORS'            => 'Do not use any colors in output. Useful when piping output to other tools or files.',  // deprecated
    'D3_LOG_CLI_OPTION_LOGLEVELS'           => 'Minimum level of messages to display. Default is "info". Valid levels are: "debug", "info", "notice", "success", "warning", "error", "critical", "alert", "emergency".',  // deprecated
    'D3_LOG_CLI_COMMAND'                    => 'This tool accepts a command as first parameter as outlined below:',   // deprecated
    'D3_LOG_CLI_COMMAND_CLEANUPLOG'         => 'cleans the d3log table from entries older than the specified time',   // deprecated
    'D3_LOG_CLI_COMMAND_LOGSTATUS'          => 'show status info for d3log table',   // deprecated
    'D3_LOG_CLI_COMMAND_LOGSTATUS_COUNT'    => 'count',    // deprecated
    'D3_LOG_CLI_COMMAND_LOGSTATUS_TYPE'     => 'log type', // deprecated
    'D3_LOG_CLI_COMMAND_LOGSTATUS_DATE'     => 'date',     // deprecated
    'D3_LOG_CLI_ARGUMENT_ENCLOSER'          => '", "',     // deprecated
    'D3_LOG_CLI_ARGUMENT_VALUE'             => 'time value (integer - the "6" at "6 months)',   // deprecated
    'D3_LOG_CLI_ARGUMENT_UNIT'              => 'time unit, possible values are: "%1$s"',  // deprecated
    'D3_LOG_CLI_FINISHED_AFFECTED'          => '%1$s entries were removed',  // deprecated
    'D3_LOG_CLI_FINISHED_SUCCFESSFULLY'     => 'script successfully finished',  // deprecated
    'D3_LOG_CLI_UNVALID_PARAMETERS'         => 'Missing or invalid parameters, please check the arguments passed',  // deprecated
