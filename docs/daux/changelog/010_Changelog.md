...
- Konverter von d3LogLevel zu Monolog LogLevel
- ermöglicht Debug Modus als Log Level zu konfigurieren
### Changed
- ergänze Dateinamenbereinigung um Umlaute und Akzente
### Fixed
- veralteter Template Cache Pfad
- Multilang Handling für Konfigurationsobjekte
- Bereinigung verwaister Einträge prüfte auf Versandkostenzuordnungen
- Syntaxfehler im Twig Pagenavigation Template

## [7.1.2.0](https://git.d3data.de/D3Private/ModCfg/compare/7.1.1.1...7.1.2.0) - 2025-01-21
### Added
- installierbar in OXID 7.2
### Changed
- Encode / Decode Aufrufe aktualisiert
### Fixed
- undefinierte Datenbankfelder werden mit Standardwert vorbelegt
