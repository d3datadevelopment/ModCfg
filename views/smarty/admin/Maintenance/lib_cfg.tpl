                ...
                <table style="border: none; padding: 0; border-spacing: 0; border-collapse: collapse">
                    <tr>
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            ...
                            <input id="blClrTmp_showcleartmpoptions" type="checkbox" name="value[blClrTmp_showcleartmpoptions]" value="1" [{if $edit->getValue('blClrTmp_showcleartmpoptions')}] checked[{/if}] [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext ext_edittext">
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            ...
                            <input id="blClrTmp_shownoheaderform" type="checkbox" name="value[blClrTmp_shownoheaderform]" value="1" [{if $edit->getValue('blClrTmp_shownoheaderform')}] checked[{/if}] [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext ext_edittext">
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            <input id="iClrTmp_tickerThreshold" type="text" size="6" maxlength="6" name="value[iClrTmp_tickerThreshold]" value="[{if $edit->getValue('iClrTmp_tickerThreshold')}][{$edit->getValue('iClrTmp_tickerThreshold')}][{else}]5000[{/if}]" [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            ...
                            <input id="blClrTmp_nohtaccess" type="checkbox" name="value[blClrTmp_nohtaccess]" value="1" [{if $edit->getValue('blClrTmp_nohtaccess')}] checked[{/if}] [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext ext_edittext">
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            ...
                            <input id="blClrTmp_nofolderremove" type="checkbox" name="value[blClrTmp_nofolderremove]" value="1" [{if $edit->getValue('blClrTmp_nofolderremove')}] checked[{/if}] [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext ext_edittext">
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            ...
                            <input id="blClrTmp_noviewupdate" type="checkbox" name="value[blClrTmp_noviewupdate]" value="1" [{if $edit->getValue('blClrTmp_noviewupdate')}] checked[{/if}] [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext ext_edittext">
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            <input id="sClrTmp_excluderegexp" type="text" size="40" maxlength="255" name="value[sClrTmp_excluderegexp]" value="[{$edit->getValue('sClrTmp_excluderegexp')}]" [{$readonly}]>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            <input type="text" size="40" maxlength="100" id="sClrTmp_useraction1name"
                                   ...
                                   value="[{if $edit->getValue('sClrTmp_useraction1name')}][{$edit->getValue('sClrTmp_useraction1name')}][{/if}]" [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext ext_edittext">
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            <input type="text" size="40" maxlength="150" id="sClrTmp_useraction1pattern"
                                   ...
                                   value="[{if $edit->getValue('sClrTmp_useraction1pattern')}][{$edit->getValue('sClrTmp_useraction1pattern')}][{/if}]" [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            <input type="text" size="40" maxlength="100" id="sClrTmp_useraction2name"
                                   ...
                                   value="[{if $edit->getValue('sClrTmp_useraction2name')}][{$edit->getValue('sClrTmp_useraction2name')}][{/if}]" [{$readonly}]>
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext ext_edittext">
                        ...
                        <td class="edittext ext_edittext" style="text-align: left">
                            <input type="text" size="40" maxlength="150" id="sClrTmp_useraction2pattern"
                                   ...
                                   value="[{if $edit->getValue('sClrTmp_useraction2pattern')}][{$edit->getValue('sClrTmp_useraction2pattern')}][{/if}]" [{$readonly}]>
                        </td>
                    </tr>
                        ...
                        <tr>
                            ...
                            <td class="edittext ext_edittext" style="text-align: left">
                                <input type="text" size="40" maxlength="100" id="sClrTmp_systemaction1name"
                                       ...
                                       value="[{if $edit->getValue('sClrTmp_systemaction1name')}][{$edit->getValue('sClrTmp_systemaction1name')}][{/if}]" [{$readonly}]>
                            </td>
                        </tr>
                        <tr>
                            <td class="edittext ext_edittext">
                            ...
                            <td class="edittext ext_edittext" style="text-align: left">
                                <input type="checkbox" id="sClrTmp_systemaction1clrtmpreplace"
                                       ...
                                       value="1" [{if $edit->getValue('sClrTmp_systemaction1clrtmpreplace')}]checked="checked"[{/if}]" [{$readonly}]>
                            </td>
                        </tr>
                        <tr>
                            <td class="edittext ext_edittext">
                            ...
                            <td class="edittext ext_edittext" style="text-align: left">
                                <input type="text" size="40" maxlength="100" id="sClrTmp_systemaction1icon"
                                       ...
                                       value="[{if $edit->getValue('sClrTmp_systemaction1icon')}][{$edit->getValue('sClrTmp_systemaction1icon')}][{/if}]" [{$readonly}]>
                            </td>
                        </tr>
                        <tr>
                            <td class="edittext ext_edittext">
                            ...
                            <td class="edittext ext_edittext" style="text-align: left">
                                <input type="text" size="40" maxlength="150" id="sClrTmp_systemaction1command"
                                       ...
                                       value="[{if $edit->getValue('sClrTmp_systemaction1command')}][{$edit->getValue('sClrTmp_systemaction1command')}][{/if}]" [{$readonly}]>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td class="edittext ext_edittext" style="text-align: left">
                                <input type="text" size="40" maxlength="100" id="sClrTmp_systemaction2name"
                                       ...
                                       value="[{if $edit->getValue('sClrTmp_systemaction2name')}][{$edit->getValue('sClrTmp_systemaction2name')}][{/if}]" [{$readonly}]>
                            </td>
                        </tr>
                        <tr>
                            <td class="edittext ext_edittext">
                            ...
                            <td class="edittext ext_edittext" style="text-align: left">
                                <input type="checkbox" id="sClrTmp_systemaction2clrtmpreplace"
                                       ...
                                       value="1" [{if $edit->getValue('sClrTmp_systemaction2clrtmpreplace')}]checked="checked"[{/if}]" [{$readonly}]>
                            </td>
                        </tr>
                        <tr>
                            <td class="edittext ext_edittext">
                            ...
                            <td class="edittext ext_edittext" style="text-align: left">
                                <input type="text" size="40" maxlength="100" id="sClrTmp_systemaction2icon"
                                       ...
                                       value="[{if $edit->getValue('sClrTmp_systemaction2icon')}][{$edit->getValue('sClrTmp_systemaction2icon')}][{/if}]" [{$readonly}]>
                            </td>
                        </tr>
                        <tr>
                            <td class="edittext ext_edittext">
                            ...
                            <td class="edittext ext_edittext" style="text-align: left">
                                <input type="text" size="40" maxlength="150" id="sClrTmp_systemaction2command"
                                       ...
                                       value="[{if $edit->getValue('sClrTmp_systemaction2command')}][{$edit->getValue('sClrTmp_systemaction2command')}][{/if}]" [{$readonly}]>
                            </td>
                        </tr>
                    [{/if}]
                    <tr>
